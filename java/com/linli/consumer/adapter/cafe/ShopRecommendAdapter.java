package com.linli.consumer.adapter.cafe;
 ...
 */
public class ShopRecommendAdapter extends Adapter<ViewHolder> {
    ...
    public ShopRecommendAdapter(Context context, List<Object> list, int type){
