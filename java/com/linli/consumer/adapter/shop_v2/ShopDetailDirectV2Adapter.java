 ...
 * 适配多种分类
 */
public class ShopDetailDirectV2Adapter extends PagerAdapter {
    ...
    private List<ShopDetailDirectGoodsV2Adapter> adapters = new ArrayList<>();
    ...
    public ShopDetailDirectV2Adapter(Context context, List<String> titlesName, List<Long> titlesId, long shopId, String shopName, int type) {
...
//        recyclerView.setAdapter(headerAndFooterWrapper);
    ...
    private XRecyclerView getRecyclerView(View view){
        ...
        SpacesItem decoration = new SpacesItem(1);
        recyclerView.addItemDecoration(decoration);
        recyclerView.setPadding(0,8,0,20);
        View header =   LayoutInflater.from(context).inflate(R.layout.shop_direct_header, null,false);
    ...
    private RecyclerView.Adapter getAdapter(List<Object> list, long titleId){
        ...
        adapter = new ShopDetailDirectGoodsV2Adapter(context,list,false,type,shopName,titleId);
        adapters.add((ShopDetailDirectGoodsV2Adapter)adapter);
        return adapter;
    }
