...
public class HorizontalGoodsAdapterSmall extends BaseAdapter {
    private List<MallGoodsVo> list;
    private Context context;

    public HorizontalGoodsAdapterSmall(List<MallGoodsVo> list, Context context) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null){
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.horizontal_good_small_cell,null);
