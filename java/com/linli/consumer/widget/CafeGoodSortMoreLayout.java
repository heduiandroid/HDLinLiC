...
public class CafeGoodSortMoreLayout extends LinearLayout {
    ...
    public CafeGoodSortMoreLayout(Context context, int sort) {
        this(context,null,sort);
        this.context = context;
    }

    public CafeGoodSortMoreLayout(Context context, AttributeSet attrs, int sort) {
        super(context, attrs);
        SORT = sort;
