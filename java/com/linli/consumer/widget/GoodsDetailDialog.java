...
public class GoodsDetailDialog extends Dialog {
    ...
    public GoodsDetailDialog(Context context, long shopId,int type){
    ...
    private GoodsDetailDialog(Context context, int theme) {
        super(context, theme);
    }
    ...
    private void initView(){
            ...
            public void onClick(View v) {
                ...
                if(goodsDbList.size() != 0){
                    for(int i = 0 ;i<goodsDbList.size();i++){      //清空本地数据库
                        dbUtil.deleteByGoodId(goodsDbList.get(i).getGoodId(),0);
                    }
                    updateDialogView();
                }
        ...
        bottomLayout.setCommitClickListener(new ShopDetailBottomLayout.OnCommitClickListener() {
            ...
            public void onCommit() {
                ...
                UIHelper.togoShopFoodOrderActivity(context,0,shopId,type,0,null);
