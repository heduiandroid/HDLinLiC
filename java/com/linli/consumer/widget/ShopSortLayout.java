 ...
 * see {@link com.linli.consumer.base.UIHelper}
 */

public class ShopSortLayout extends LinearLayout implements View.OnClickListener {
...
//商城和美食图标那一行view
    ...
    public ShopSortLayout(Context context,int SORT,String broadcast) {
        this(context,null,SORT,broadcast);

    }
    public ShopSortLayout(Context context, AttributeSet attrs,int SORT,String broadcast) {
        super(context, attrs);
