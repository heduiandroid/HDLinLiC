...
public class BackLayoutNormal extends LinearLayout {
    ...
    public BackLayoutNormal(Context context) {
        super(context);
    }

    public BackLayoutNormal(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.back_layout_normal,this);
        initView(context);
    }
