...
public class PaiYiPaiAdvertisementTextActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pai_yi_pai_advertisement_text);
        init();
        ...
        if (merchantId == 0 || id == 0){
            Toast.makeText(PaiYiPaiAdvertisementTextActivity.this, "还没有商家优惠信息哦~", Toast.LENGTH_SHORT).show();
            finish();
        }else {
            request_shopcate();
            show_advertasiment();
