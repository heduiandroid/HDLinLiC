...
public class ScrollViewContainer extends RelativeLayout {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        Log.i("WATER","topView  "+"mMoveLen="+(int) mMoveLen+"  mViewWidth="+mViewWidth+"  topView H"+ (topView.getMeasuredHeight() + (int) mMoveLen));

        bottomView.layout(0, topView.getMeasuredHeight() + (int) mMoveLen+180,
                mViewWidth, topView.getMeasuredHeight() + (int) mMoveLen
                        + bottomView.getMeasuredHeight()+180);
        Log.i("WATER","bottomView  "+"mMoveLen="+((int) topView.getMeasuredHeight() + (int) mMoveLen)+"  mViewWidth="+mViewWidth+"  topView H"+(topView.getMeasuredHeight() + (int) mMoveLen
