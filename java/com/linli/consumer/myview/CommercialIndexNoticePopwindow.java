...
/**
 * Created by wwy on 2016/6/1.
 */
public class CommercialIndexNoticePopwindow extends PopupWindow implements View.OnClickListener {
    private View mView;


    public CommercialIndexNoticePopwindow(Activity activity) {
        LayoutInflater inflater = activity.getLayoutInflater();//得到activity
        mView = inflater.inflate(R.layout.popouwindow_commercial_index_notice, null);
